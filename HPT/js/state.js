...
React.useEffect(() => {
    ...
    // Unified helper ensures class list and native PWA frame always change together
    ...
    if (settings.theme === 'dark') {
        ...
        updateTheme(false);
    } else { // System theme configuration
        ...
        handleChange(); // Initial setup evaluation
        
        // Return cleanup function specifically for the event listener hook
