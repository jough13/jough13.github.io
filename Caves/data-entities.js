...
window.QUEST_DATA = {
    ...
    "healerSupply": {
        ...
        type: 'collect', itemNeeded: 'Medicinal Herb', needed: 5, enemy: null, itemTile: null,
    ...
    "goblinHeirloom": {
        ...
        type: 'fetch', enemy: 'g', itemNeeded: 'Heirloom', needed: 1, itemTile: '♦',
        reward: { xp: 150, coins: 100, item: null, itemQty: 0 }
    },
    "goblinTrophies": {
        ...
        type: 'collect', itemNeeded: 'Goblin Totem', needed: 10, enemy: null, itemTile: null,
        reward: { xp: 200, coins: 150, item: null, itemQty: 0 }
    },
    "wolfHunt": {
        title: "Bounty: Wolf Hunt",
        description: "\"The winter has made the packs bold. They took two sheep last night. Slay 10 Wolves ('w').\"",
        type: 'kill', enemy: 'w', itemNeeded: null, needed: 10, itemTile: null,
        reward: { xp: 100, coins: 50, item: null, itemQty: 0 }
    },
    "goblinHunt": {
        ...
        type: 'kill', enemy: 'g', itemNeeded: null, needed: 15, itemTile: null,
        reward: { xp: 75, coins: 30, item: null, itemQty: 0 }
    },
    "skeletonScourge": {
        ...
        type: 'kill', enemy: 's', itemNeeded: null, needed: 10, itemTile: null,
        reward: { xp: 100, coins: 50, item: null, itemQty: 0 }
    },
    "spiderHunt": {
        title: "Bounty: Spider Nest",
        description: "\"The eastern caves are crawling with giant arachnids ('@'). Burn out their nests.\"",
        type: 'kill', enemy: '@', itemNeeded: null, needed: 12, itemTile: null,
        reward: { xp: 120, coins: 80, item: null, itemQty: 0 }
    },
    ...
    "banditCleanup": {
        ...
        type: 'kill', enemy: 'b', itemNeeded: null, needed: 12, itemTile: null,
        reward: { xp: 120, coins: 75, item: null, itemQty: 0 }
    },
    "banditChief": {
        title: "Wanted: The Chief",
        description: "\"The Bandit Chief ('C') has occupied the ruined fortresses. Put a permanent end to his reign.\"",
        type: 'kill', enemy: 'C', itemNeeded: null, needed: 1, itemTile: null,
    ...
    "orcHunt": {
        ...
        type: 'kill', enemy: 'o', itemNeeded: null, needed: 8, itemTile: null,
        reward: { xp: 150, coins: 100, item: null, itemQty: 0 }
    },
    "mageMenace": {
        ...
        type: 'kill', enemy: 'm', itemNeeded: null, needed: 5, itemTile: null,
        reward: { xp: 180, coins: 120, item: null, itemQty: 0 }
    },
    "draugrProblems": {
        ...
        type: 'kill', enemy: 'Z', itemNeeded: null, needed: 5, itemTile: null,
        reward: { xp: 200, coins: 150, item: null, itemQty: 0 }
    },
    "trollHunt": {
        ...
        type: 'kill', enemy: 'Ø', itemNeeded: null, needed: 1, itemTile: null,
    ...
    "cultistCleanup": {
        ...
        type: 'kill', enemy: 'c', itemNeeded: null, needed: 8, itemTile: null,
        reward: { xp: 180, coins: 120, item: null, itemQty: 0 }
    },
    "golemBreaker": {
        title: "Bounty: Stone Golems",
        description: "\"The earth itself is rejecting us. Slay 3 Stone Golems ('🧌') to secure the quarries.\"",
        type: 'kill', enemy: '🧌', itemNeeded: null, needed: 3, itemTile: null,
        reward: { xp: 300, coins: 200, item: null, itemQty: 0 }
    },
    "alphaHide": {
        ...
        type: 'collect', itemNeeded: 'Alpha Pelt', needed: 1, enemy: null, itemTile: null,
    ...
    "starMetalCrafter": {
        ...
        type: 'collect', itemNeeded: 'Star-Metal Ore', needed: 1, enemy: null, itemTile: null,
        reward: { xp: 500, coins: 300, item: null, itemQty: 0 }
    },
    "cultistGenerals": {
    ...
    "voidDemons": {
        ...
        type: 'kill', enemy: '😈d', itemNeeded: null, needed: 5, itemTile: null,
    ...
    "krakenHunt": {
        ...
        type: 'kill', enemy: '🦑', itemNeeded: null, needed: 1, itemTile: null,
    ...
    "astralFishing": {
        ...
        type: 'collect', itemNeeded: 'Astral Jelly', needed: 3, enemy: null, itemTile: null,
...
window.ENEMY_DATA = {
    ...
    'r': {
        name: 'Giant Rat', tags: ['beast', 'vermin'], mountable: false,
        ...
        loot: '🐀', color: '#a8a29e', isBoss: false, excludeFromLoot: false,
    ...
    '🐍': {
        name: 'Viper', tags: ['beast', 'reptile', 'poison'], mountable: false,
        maxHealth: 4, attack: 2, defense: 0, xp: 8,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'poison', inflictChance: 0.2, teleporter: false,
    ...
    'R': {
        name: 'Bandit Recruit', tags: ['humanoid'], mountable: false,
    ...
    '🍄s': {
        name: 'Sporeling', tags: ['fungus', 'poison'], mountable: false,
        maxHealth: 4, attack: 1, defense: 1, xp: 6,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'poison', inflictChance: 0.15, teleporter: false,
        loot: '🍄', color: '#d946ef', isBoss: false, excludeFromLoot: false,
        flavor: "A tiny, aggressive walking mushroom. It releases a cloud of choking dust when threatened."
    },
    '⚙️s': {
        name: 'Clockwork Spider', tags: ['construct', 'metal'], mountable: false,
    ...
    // --- DESERT WILDLIFE ---
    '🦂s': { 
        name: 'Sand Scorpion', tags: ['bug', 'poison'], mountable: false,
        maxHealth: 5, attack: 2, defense: 1, xp: 8,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'poison', inflictChance: 0.3, teleporter: false,
        loot: '🦷', color: '#d97706', isBoss: false, excludeFromLoot: false,
        flavor: "It burrows perfectly into the dunes, leaving only its venomous stinger exposed to the sun."
    },
    '🐍c': { 
        name: 'King Cobra', tags: ['beast', 'reptile', 'poison'], mountable: false,
        maxHealth: 15, attack: 5, defense: 0, xp: 30,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'poison', inflictChance: 0.5, teleporter: false,
    ...
    // --- SWAMP WILDLIFE ---
    '🐸': {
        name: 'Giant Toad', tags: ['beast'], mountable: false,
        maxHealth: 20, attack: 3, defense: 0, xp: 25,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '🍖', color: '#15803d', isBoss: false, excludeFromLoot: false,
    ...
    '🦟': {
        ...
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: 'vd', color: '#be123c', isBoss: false, excludeFromLoot: false,
        flavor: "An annoying, high-pitched whine follows it. It is swollen and red with stolen blood."
    },

    // --- AQUATIC WILDLIFE ---
    '🦈': {
        name: 'Great Shark', tags: ['beast', 'aquatic'], mountable: false,
        maxHealth: 25, attack: 6, defense: 1, xp: 35,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '🐟', color: '#94a3b8', isBoss: false, excludeFromLoot: false,
        flavor: "A massive, scarred dorsal fin slices through the water. It has smelled you."
    },
    '🦀': {
        name: 'Giant Crab', tags: ['beast', 'aquatic', 'stone'], mountable: false,
        maxHealth: 18, attack: 4, defense: 5, xp: 25,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '🍖', color: '#ea580c', isBoss: false, excludeFromLoot: false,
        flavor: "Its heavily armored shell is nearly impenetrable, and its claws can snap a ship's oar in half."
    },
    '🦑': {
        name: 'Kraken', tags: ['beast', 'aquatic', 'monster', 'boss'], mountable: false,
        maxHealth: 200, attack: 12, defense: 4, xp: 800,
        caster: true, castRange: 4, spellDamage: 8, isRanged: false, range: 0,
        inflicts: 'root', inflictChance: 0.5, teleporter: false,
        loot: '🐙', color: '#7c3aed', isBoss: true, excludeFromLoot: false,
        flavor: "Massive, writhing tentacles burst from the deep ocean! It pulls entire galleons into the abyss."
    },
    '🧜‍♀️': {
        name: 'Siren', tags: ['humanoid', 'aquatic', 'magic'], mountable: false,
        ...
        loot: '🐚', color: '#38bdf8', isBoss: false, excludeFromLoot: false,
        flavor: "Her song is beautiful and tragic, but beneath the water, her eyes are pitch black and hungry."
    },
    '🦕': {
        name: 'Abyssal Leviathan', tags: ['beast', 'aquatic', 'monster', 'boss'], mountable: false,
        maxHealth: 300, attack: 15, defense: 5, xp: 1500,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '💎b', color: '#0284c7', isBoss: true, excludeFromLoot: false,
    ...
    'g': {
        name: 'Goblin', tags: ['humanoid', 'goblin'], mountable: false,
        maxHealth: 6, attack: 2, defense: 0, xp: 12,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: 't', color: '#16a34a', isBoss: false, excludeFromLoot: false,
    ...
    'w': {
        ...
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: 'p', color: '#78716c', isBoss: false, excludeFromLoot: false,
        flavor: "A lean, hungry predator of the wilds. It circles you, waiting for an opening."
    },
    's': {
        name: 'Skeleton', tags: ['undead', 'bone'], mountable: false,
        maxHealth: 10, attack: 3, defense: 1, xp: 18,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '(', color: '#e5e7eb', isBoss: false, excludeFromLoot: false,
        flavor: "Once the King's elite guard. Even in death, their bones are bound by an oath to protect the ruins."
    },
    'b': {
        name: 'Bandit', tags: ['humanoid'], mountable: false,
        maxHealth: 10, attack: 2, defense: 1, xp: 20,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: 'i', color: '#ef4444', isBoss: false, excludeFromLoot: false,
        flavor: "Desperate men driven to crime by a dying world. They fight dirty."
    },
    '👺': {
        name: 'Goblin Archer', tags: ['humanoid', 'goblin'], mountable: false,
        maxHealth: 5, attack: 3, defense: 0, xp: 15,
        caster: false, castRange: 0, spellDamage: 0, isRanged: true, range: 5,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '➹', color: '#16a34a', isBoss: false, excludeFromLoot: false,
        flavor: "It draws back a crudely strung shortbow, giggling as it aims for your knees."
    },
    '👺m': {
        name: 'Goblin Shaman', tags: ['humanoid', 'goblin', 'magic'], mountable: false,
        maxHealth: 8, attack: 1, defense: 0, xp: 25,
        caster: true, castRange: 4, spellDamage: 4, isRanged: false, range: 0,
        inflicts: 'root', inflictChance: 0.3, teleporter: false,
        loot: '🔮', color: '#4ade80', isBoss: false, excludeFromLoot: false,
        flavor: "It wears a skull mask and chants in a guttural tongue, commanding the roots of the earth."
    },
    '💀a': {
        name: 'Skeleton Archer', tags: ['undead', 'bone'], mountable: false,
        maxHealth: 8, attack: 4, defense: 1, xp: 20,
        caster: false, castRange: 0, spellDamage: 0, isRanged: true, range: 6,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '➹', color: '#e5e7eb', isBoss: false, excludeFromLoot: false,
        flavor: "Its aim is supernaturally steady, completely unaffected by breath, heartbeat, or fear."
    },
    'k': {
        name: 'Kobold', tags: ['humanoid', 'reptile'], mountable: false,
    ...
    '🐗': {
        ...
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '🍖', color: '#57534e', isBoss: false, excludeFromLoot: false,
        flavor: "It scrapes its razor-sharp tusks against the ground, preparing to charge in a blind rage."
    },
    'a': {
        name: 'Shadow Acolyte', tags: ['humanoid', 'void', 'magic'], mountable: false,
    ...
    '👻i': {
        name: 'Ice Wraith', tags: ['undead', 'ethereal', 'frost'], mountable: false,
        maxHealth: 10, attack: 3, defense: 2, xp: 20,
        caster: true, castRange: 4, spellDamage: 4, isRanged: false, range: 0,
        inflicts: 'frostbite', inflictChance: 0.3, teleporter: false,
        loot: 'E', color: '#7dd3fc', isBoss: false, excludeFromLoot: false,
        flavor: "A screaming soul trapped forever in the biting cold. To touch it is to feel the grave."
    },
    
    // --- NEW FAE & FLYING ENEMIES ---
    '🧚': {
        name: 'Fae Trickster', tags: ['humanoid', 'fae', 'magic'], mountable: false,
        maxHealth: 15, attack: 2, defense: 0, xp: 35,
        caster: true, castRange: 5, spellDamage: 4, isRanged: false, range: 0,
    ...
    '@': {
        ...
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'poison', inflictChance: 0.2, teleporter: false,
        loot: '"', color: '#1f2937', isBoss: false, excludeFromLoot: false,
        flavor: "It moves with terrifying, silent speed, its eight eyes reflecting the moonlight."
    },
    '🦂': {
        name: 'Giant Scorpion', tags: ['bug', 'poison'], mountable: false,
        maxHealth: 12, attack: 4, defense: 2, xp: 30,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'poison', inflictChance: 0.2, teleporter: false,
        loot: 'i', color: '#b45309', isBoss: false, excludeFromLoot: false,
        flavor: "Its carapace deflects blades, and its stinger drips with neurotoxin."
    },
    'l': {
        name: 'Giant Leech', tags: ['bug', 'aquatic'], mountable: false,
    ...
    'o': {
        name: 'Orc Brute', tags: ['humanoid', 'orc'], mountable: false,
        maxHealth: 20, attack: 5, defense: 1, xp: 40,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: 'U', color: '#14532d', isBoss: false, excludeFromLoot: false,
        flavor: "A towering wall of muscle and rage. They respect nothing but overwhelming violence."
    },
    'Z': {
        name: 'Draugr', tags: ['undead', 'frost'], mountable: false,
        maxHealth: 18, attack: 4, defense: 2, xp: 35,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'frostbite', inflictChance: 0.2, teleporter: false,
        loot: 'E', color: '#38bdf8', isBoss: false, excludeFromLoot: false,
        flavor: "Ancient northmen, preserved perfectly by the biting frost. Their eyes glow with pale blue light."
    },
    '👷': {
        name: 'Undead Miner', tags: ['undead'], mountable: false,
    ...
    '👁️': {
        name: 'Void Watcher', tags: ['void', 'monster', 'ethereal'], mountable: false,
        maxHealth: 15, attack: 1, defense: 0, xp: 45,
        caster: true, castRange: 6, spellDamage: 5, isRanged: false, range: 0,
    ...
    '🐺': {
        ...
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '🐺', color: '#44403c', isBoss: false, excludeFromLoot: false,
    ...
    'Ø': { 
        ...
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '$', color: '#84cc16', isBoss: false, excludeFromLoot: false,
        flavor: "Dull-witted but incredibly destructive. It uses entire tree trunks as clubs."
    },
    'Y': {
        name: 'Yeti', tags: ['beast', 'frost', 'giant'], mountable: false,
        maxHealth: 40, attack: 6, defense: 2, xp: 90,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'frostbite', inflictChance: 0.2, teleporter: false,
        loot: '❄️f', color: '#f8fafc', isBoss: false, excludeFromLoot: false,
        flavor: "The undisputed apex predator of the frozen peaks. It blends perfectly into the blizzards."
    },
    'm': {
        name: 'Arcane Mage', tags: ['humanoid', 'magic', 'void'], mountable: false,
        maxHealth: 15, attack: 2, defense: 0, xp: 50,
        caster: true, castRange: 6, spellDamage: 6, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '&', color: '#c084fc', isBoss: false, excludeFromLoot: false,
        flavor: "A scholar who stared too long into the Void. Their body is now just a crumbling vessel for forbidden math."
    },
    'C': {
        name: 'Bandit Chief', tags: ['humanoid'], mountable: false,
        maxHealth: 25, attack: 5, defense: 2, xp: 50,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: 'i', color: '#991b1b', isBoss: false, excludeFromLoot: false,
        flavor: "A ruthless leader clad in stolen armor, demanding heavy tolls in blood and gold."
    },
    'f': {
        name: 'Fire Elemental', tags: ['elemental', 'fire', 'ethereal'], mountable: false,
        maxHealth: 20, attack: 5, defense: 3, xp: 60,
        caster: true, castRange: 4, spellDamage: 5, isRanged: false, range: 0,
        inflicts: 'burn', inflictChance: 0.5, teleporter: false,
        loot: '🔥c', color: '#fb923c', isBoss: false, excludeFromLoot: false,
        flavor: "A walking inferno of pure elemental rage. The ground turns to glass where it walks."
    },
    '👻': {
        name: 'Lost Soul', tags: ['undead', 'ethereal'], type: 'spirit', mountable: false,
        maxHealth: 15, attack: 3, defense: 0, xp: 20,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: 'ectoplasm', color: '#8b5cf6', isBoss: false, excludeFromLoot: false,
        flavor: "It wails silently, trapped between realms. A tragic echo of the Fall."
    },
    '😈d': {
        name: 'Void Demon', tags: ['demon', 'void', 'ethereal'], mountable: false,
        maxHealth: 50, attack: 8, defense: 4, xp: 200,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'madness', inflictChance: 0.2, teleporter: true, 
        loot: '😈', color: '#581c87', isBoss: false, excludeFromLoot: false,
        flavor: "A fragment of the nothingness that existed before the First Age. It hates all life."
    },
    'v': {
        name: 'Void Stalker', tags: ['void', 'monster'], mountable: false,
        maxHealth: 15, attack: 6, defense: 1, xp: 55,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: true,
        loot: 'vd', color: '#7c3aed', isBoss: false, excludeFromLoot: false,
        flavor: "It phases in and out of reality, tracking your scent through higher dimensions."
    },
    'M': {
        name: 'Mimic', tags: ['monster', 'construct'], mountable: false,
        maxHealth: 20, attack: 6, defense: 2, xp: 50,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'root', inflictChance: 0.3, teleporter: false,
        loot: '💍', color: '#854d0e', isBoss: false, excludeFromLoot: false,
        flavor: "A monstrous shape-shifter hoping for a greedy victim. Its tongue is sticky with acid."
    },
    '🧟': {
        name: 'Spore Zombie', tags: ['undead', 'fungus', 'poison'], mountable: false,
        maxHealth: 18, attack: 4, defense: 0, xp: 25,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'poison', inflictChance: 0.4, teleporter: false,
        loot: '🍄', color: '#86efac', isBoss: false, excludeFromLoot: false,
        flavor: "It was once an adventurer. Now, glowing fungal networks control its nervous system."
    },
    '🪨c': {
        name: 'Crystal Behemoth', tags: ['elemental', 'stone'], mountable: false,
        maxHealth: 35, attack: 5, defense: 4, xp: 60,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '💎', color: '#22d3ee', isBoss: false, excludeFromLoot: false,
        flavor: "Its crystalline hide reflects the ambient light... and deflects your attacks with ease."
    },
    '🤖': {
        name: 'Clockwork Guardian', tags: ['construct', 'metal'], mountable: false,
    ...
    '🐛': {
        ...
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '🦷', color: '#d97706', isBoss: true, excludeFromLoot: false,
        flavor: "The ground shakes before it erupts from the sand, a massive maw of a thousand spinning teeth."
    },
    '🧙': {
        name: 'Necromancer Lord', tags: ['humanoid', 'magic', 'undead', 'boss'], mountable: false,
        maxHealth: 80, attack: 7, defense: 3, xp: 1000,
        caster: true, castRange: 7, spellDamage: 8, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '👑', color: '#000000', isBoss: true, excludeFromLoot: false,
    ...
    'c': {
        name: 'Cultist Initiate', tags: ['humanoid', 'void', 'magic'], mountable: false,
        maxHealth: 12, attack: 3, defense: 0, xp: 25,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '📜', color: '#be185d', isBoss: false, excludeFromLoot: false,
        flavor: "He mutters fanatical prayers to a sleeping god in the dark."
    },
    'z': {
        name: 'Cultist Fanatic', tags: ['humanoid', 'void', 'magic'], mountable: false,
    ...
    '🐲': {
        ...
        loot: '🐉', color: '#dc2626', isBoss: false, excludeFromLoot: false,
    ...
    '🦖': {
        ...
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: null, inflictChance: 0, teleporter: false,
        loot: '🦖', color: '#14532d', isBoss: false, excludeFromLoot: false,
        flavor: "The earth physically shakes with every heavy step. It is the king of the deep jungles."
    },
    '🧛': {
        name: 'Vampire Lord', tags: ['undead', 'humanoid', 'magic'], mountable: false,
        maxHealth: 80, attack: 10, defense: 3, xp: 600,
        caster: true, castRange: 5, spellDamage: 8, isRanged: false, range: 0,
        inflicts: 'siphon', inflictChance: 1.0, teleporter: false,
        loot: '🩸', color: '#e11d48', isBoss: false, excludeFromLoot: false,
        flavor: "He moves faster than your eyes can follow, elegant, aristocratic, and completely merciless."
    },
    '👾': {
        name: 'Eldritch Horror', tags: ['void', 'demon', 'ethereal', 'monster'], mountable: false,
        maxHealth: 200, attack: 15, defense: 0, xp: 800,
        caster: false, castRange: 0, spellDamage: 0, isRanged: false, range: 0,
        inflicts: 'madness', inflictChance: 0.5, teleporter: false,
        loot: 'vd', color: '#8b5cf6', isBoss: false, excludeFromLoot: false,
        flavor: "Its geometry makes no sense. To look directly at it is to invite your own mind to shatter."
    },
    '🐉h': {
        name: 'Swamp Hydra', tags: ['beast', 'reptile', 'dragon', 'poison'], mountable: false,
    ...
    '🔥e': {
        name: 'Efreet', tags: ['elemental', 'fire', 'demon', 'ethereal'], mountable: false,
        maxHealth: 60, attack: 8, defense: 1, xp: 150,
        caster: true, castRange: 5, spellDamage: 6, isRanged: false, range: 0,
        inflicts: 'burn', inflictChance: 0.6, teleporter: false,
        loot: '🔥c', color: '#f97316', isBoss: false, excludeFromLoot: false,
    ...
    '☠️': {
        ...
        caster: true, castRange: 6, spellDamage: 12, isRanged: false, range: 0,
        inflicts: 'madness', inflictChance: 0.3, teleporter: false,
        loot: '🧿e', color: '#000000', isBoss: true, excludeFromLoot: false,
    ...
    '🩸c': {
        name: 'Arena Champion', tags: ['undead', 'bone', 'boss'], mountable: false,
...
window.SPELL_DATA = {
    "candlelight": {
        ...
        cooldown: 5, scalingStat: null, baseDamage: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "chainLightning": {
        ...
        cooldown: 4, type: null, duration: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "stoneSkin": {
        name: "Stone Skin",
        ...
        cooldown: 5, baseDamage: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "lesserHeal": {
        name: "Lesser Heal",
        ...
        cooldown: 3, type: null, duration: 0, baseDamage: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "clarity": {
        name: "Clarity",
        ...
        cooldown: 2, scalingStat: null, duration: 0, baseDamage: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "raiseDead": {
        name: "Raise Dead",
        ...
        cost: 15, costType: "mana", requiredLevel: 1, target: "aimed", element: "dark",
        cooldown: 5, type: null, duration: 0, baseDamage: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "arcaneShield": {
        name: "Arcane Shield",
        ...
        cooldown: 4, baseDamage: 0, baseHeal: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "fireball": {
        name: "Fireball",
    ...
    "siphonLife": {
        ...
        cooldown: 2, type: null, duration: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "thunderbolt": {
        name: "Thunderbolt",
        ...
        cooldown: 3, type: null, duration: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "meteor": {
        name: "Meteor",
    ...
    "divineLight": {
        ...
        cost: 25, costType: "psyche", requiredLevel: 5, target: "self", type: "utility", element: "holy", AoE: true, radius: 2,
        cooldown: 8, scalingStat: null, duration: 0, baseDamage: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, inflicts: null, inflictChance: 0
    },
    "magicBolt": {
        name: "Magic Bolt",
        ...
        cooldown: 1, type: null, duration: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "psychicBlast": {
        name: "Psychic Blast",
        ...
        cooldown: 2, type: null, duration: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "frostBolt": {
        name: "Frost Bolt",
        ...
        cooldown: 2, type: null, duration: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false
    },
    "poisonBolt": {
        name: "Poison Bolt",
    ...
    "darkPact": {
        ...
        cooldown: 2, type: null, duration: 0, baseDamage: 0, baseHeal: 0, baseShield: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false, inflicts: null, inflictChance: 0
    },
    "entangle": {
        name: "Entangle",
        ...
        cooldown: 4, type: null, duration: 0, baseHeal: 0, baseShield: 0, baseRestore: 0, baseReflect: 0, healPercent: 0, radius: 0, AoE: false
    },
    "thornSkin": {
        name: "Thorn Skin",
...
// 🚨 V8 OPTIMIZATION: Strict schemas applied to SKILL_DATA
window.SKILL_DATA = {
    // --- BASIC TECHNIQUES ---
    "kick": {
        name: "Kick",
        ...
        scalingStat: null, type: null, baseDefense: 0, duration: 0, AoE: false, weaponTags: []
    },
    "vanish": {
        name: "Vanish",
        ...
        scalingStat: null, baseDamageMultiplier: 0, baseDefense: 0, duration: 0, AoE: false, weaponTags: []
    },
    "brace": {
        name: "Brace",
        ...
        baseDamageMultiplier: 0, AoE: false, weaponTags: [] 
    },
    "tame": {
        name: "Tame Beast",
        ...
        type: null, baseDamageMultiplier: 0, baseDefense: 0, duration: 0, AoE: false, weaponTags: []
    },
    "lunge": {
        name: "Lunge",
        ...
        type: null, baseDefense: 0, duration: 0, AoE: false, weaponTags: [] 
    },
    "shieldBash": {
        name: "Shield Bash",
    ...
    "cleave": {
        ...
        type: null, baseDefense: 0, duration: 0, weaponTags: []
    },
    "adrenaline": {
        name: "Adrenaline",
        ...
        scalingStat: null, type: null, baseDamageMultiplier: 0, baseDefense: 0, duration: 0, AoE: false, weaponTags: []
    },
    "pacify": {
        name: "Pacify",
    ...
    "whirlwind": {
        ...
        type: null, baseDamageMultiplier: 0, baseDefense: 0, duration: 0, weaponTags: []
    },
    "stealth": {
        name: "Stealth",
        ...
        scalingStat: null, type: null, baseDamageMultiplier: 0, baseDefense: 0, AoE: false, weaponTags: []
    },
    // --- WEAPON TECHNIQUES ---
    "crush": {
        name: "Crush",
    ...
    "quickstep": {
        ...
        scalingStat: null, baseDamageMultiplier: 0, baseDefense: 0, duration: 0, AoE: false
    },
    "deflect": {
        name: "Deflect",
        ...
        scalingStat: null, type: null, baseDamageMultiplier: 0, baseDefense: 0, AoE: false
    },
    "channel": {
        name: "Channel",
        ...
        scalingStat: null, type: null, baseDamageMultiplier: 0, baseDefense: 0, duration: 0, AoE: false
    },
    "ranged_attack": {
        name: "Shoot",
