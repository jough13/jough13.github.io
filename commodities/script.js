        ...
        const nrcExemptionValues = {
            ...
            'H-3': '1,000 µCi', 'Kr-85': '100 µCi', 'Ni-63': '100 µCi',
        ...
        const dotExemptionValues = {
            ...
            'C-14': '270 µCi', 'Tc-99': '270 µCi'
        };
        const un2911Limits = {
            'Am-241': '0.00027 Ci', 'C-14': '0.81 Ci', 'Co-60': '0.11 Ci', 'Cs-137': '0.16 Ci',
            'H-3': '22 Ci', 'Kr-85': '0.27 Ci', 'Ni-63': '8.1 Ci',
        ...
        const un2911PkgLimits = {
            ...
            'H-3': '220 Ci', 'Kr-85': '2.7 Ci', 'Ni-63': '810 Ci',
        ...
        const dotA2Values = {
            ...
            'H-3': '1100 Ci', 'Kr-85': '270 Ci', 'Ni-63': '810 Ci',
        ...
        function parseValueToCi(valueStr) {
            ...
            // This regex separates numbers from text
            const parts = valueStr.match(/([0-9.]+)\s*([a-zA-Zµ]+)/);
        ...
        function populateTable(data) {
            ...
            const rows = data.map((item) => {
                // NEW: Check if this ID is in our Set
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function calculateDisposalPackageAnalysis() {
                ...
                // Updated logic checks Item Limits BEFORE Package Limits
                if (dotExemptSum <= 1) {
